...
class App extends Component {
  ...
  async componentDidMount() {
    ...
    if (TEST_WITH_NEW_CUSTOMER) {
      window.localStorage.removeItem(FREECOM_CUSTOMER_ID_KEY)
      window.localStorage.removeItem(FREECOM_CUSTOMER_NAME_KEY)
      window.localStorage.removeItem(FREECOM_CUSTOMER_SECRET_KEY)
      window.localStorage.removeItem(FREECOM_AUTH_TOKEN_KEY)
    }

    const customerId = window.localStorage.getItem(FREECOM_CUSTOMER_ID_KEY)
    const username = window.localStorage.getItem(FREECOM_CUSTOMER_NAME_KEY)
  ...
  _setupNewCustomer = async () => {
    //authentication
    const secret = cuid()
    window.localStorage.setItem(FREECOM_CUSTOMER_SECRET_KEY, secret)
    ...
    window.localStorage.setItem(FREECOM_AUTH_TOKEN_KEY, authToken)
    window.localStorage.setItem(FREECOM_CUSTOMER_ID_KEY, customerId)
    //initialization
    ...
    window.localStorage.setItem(FREECOM_CUSTOMER_NAME_KEY, username)
    //update state
    this.setState({
